! function(e) {
    ...
    var r, s, n = n || function(e) {
        ...
        if (!("undefined" == typeof e || "undefined" != typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent))) {
                ...
                p = function(t, h, c) {
                    ...
                    var p, f = this,
                        ...
                        E = function() {
                            ...
                            if (p || (p = i().createObjectURL(t)), g) e.location.href = p;
                            else {
            ...
            } : (f.abort = function() {}, f.readyState = f.INIT = 0, f.WRITING = 1, f.DONE = 2, f.error = f.onwritestart = f.onprogress = f.onwrite = f.onabort = f.onerror = f.onwriteend = null, b)
        }
    ...
    THREE.OrbitControls = function(e, t) {
        ...
        function R(e) {
            if (z.enabled !== !1)
                if (e.preventDefault(), U === L.ROTATE) {
                    if (z.enableRotate === !1) return;
                    d(e)
                } else if (U === L.DOLLY) {
                if (z.enableZoom === !1) return;
    ...
    i.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (this.idx.position > t.position)
                for (key in this.idx)
                    for (var r = "uv" === key ? 2 : 3, i = e[key] * r, s = (t[key] + 1) * r, n = this.idx[key] * r, a = s; a < n; a++) this.current.attributes[key].array[i++] = this.current.attributes[key].array[a];
            for (key in this.idx) {
                var o = t[key] - e[key];
                this.idx[key] -= o
            }
        ...
        addBuffer: function(e) {
            var t = new THREE.BufferGeometry,
                i = new Float32Array(3 * this.maxBufferSize),
                r = new Float32Array(3 * this.maxBufferSize),
                s = new Float32Array(2 * this.maxBufferSize),
                n = new Float32Array(3 * this.maxBufferSize),
                a = new THREE.Mesh(t, this.material);
            ...
            if (o || (o = document.createElement("a-entity"), o.className = "a-drawing", document.querySelector("a-scene").appendChild(o)), o.object3D.add(this.object3D), this.object3D.add(a), t.setDrawRange(0, 0), t.addAttribute("position", new THREE.BufferAttribute(i, 3).setDynamic(!0)), t.addAttribute("uv", new THREE.BufferAttribute(s, 2).setDynamic(!0)), t.addAttribute("normal", new THREE.BufferAttribute(r, 3).setDynamic(!0)), t.addAttribute("color", new THREE.BufferAttribute(n, 3).setDynamic(!0)), this.previous = null, this.geometries.length > 0 && (this.previous = this.current), this.idx = {
                ...
                var h = 3 * (this.maxBufferSize - 2),
                    u = 3 * (this.maxBufferSize - 2),
    ...
    window.addEventListener("load", function(e) {
        var t = document.getElementById("apainter-ui"),
            i = document.querySelector("#apainter-ui .share"),
            r = document.getElementById("apainter-share-url"),
            s = document.querySelector("#apainter-ui .progress"),
    ...
    AFRAME.BRUSHES = {}, APAINTER_STATS = {
        brushes: {}
    }, AFRAME.registerBrush = function(e, t, i) {
        function r(e) {
        ...
        a.prototype = {
            ...
            getBinary: function(e) {
                var t = 21 + 36 * this.data.points.length,
                    i = new BinaryManager(new ArrayBuffer(t));
        ...
        removeById: function(e) {
            ...
            if (console.log(t, this.strokes), t) {
                for (var i = this.strokes.length - 1; i > e; i--)
                    if (stroke = this.strokes[i], t.sharedBuffer === stroke.sharedBuffer) {
        ...
        tick: function(e, t) {
            if (this.strokes.length)
                for (var i = 0; i < this.strokes.length; i++) this.strokes[i].tick(e, t)
        },
        ...
        generateRandomStrokes: function(e) {
            ...
            for (var i = document.querySelector("#left-hand"), r = Object.keys(AFRAME.BRUSHES), s = 0; s < e; s++) {
                var n = r[parseInt(13 * Math.random())],
                    a = new THREE.Color(Math.random(), Math.random(), Math.random()),
                    o = .3 * Math.random(),
                    h = parseInt(500 * Math.random()),
                    u = this.addNewStroke(n, a, o);
                i.emit("stroke-started", {
                    entity: i,
                    stroke: u
                });
        ...
        getBinary: function() {
            var e = [],
                t = "apainter",
                i = this.getUsedBrushes(),
                s = t.length + i.join(" ").length + 9,
        ...
        getPointerPosition: function() {
            ...
            return function(i, r) {
                ...
                var s = t[this.controllerName],
                    n = s.vec.clone().applyQuaternion(r).normalize().multiplyScalar(s.mult);
        ...
        loadJSON: function(e) {
            ...
            for (var t = 0; t < e.strokes.length; t++)
                for (var i = e.strokes[t], s = i.brush, n = this.addNewStroke(e.brushes[s.index], (new THREE.Color).fromArray(s.color), s.size), a = 0; a < i.points.length; a++) {
                    var o = i.points[a],
                        h = (new THREE.Vector3).fromArray(o.position),
                        u = (new THREE.Quaternion).fromArray(o.orientation),
                        c = o.pressure,
                        d = o.timestamp,
        ...
        loadBinary: function(e) {
            ...
            for (var h = t.readUint32(), u = 0; u < h; u++)
                for (var c = t.readUint8(), d = t.readColor(), l = t.readFloat(), m = t.readUint32(), p = this.addNewStroke(a[c], d, l), f = 0; f < m; f++) {
                    var b = t.readVector3(),
                        g = t.readQuaternion(),
                        v = t.readFloat(),
                        E = t.readUint32(),
    ...
    AFRAME.registerSystem("ui", {
        ...
        initTextures: function() {
            ...
            var i = this,
                r = "assets/images/ui-hover.png",
                s = "assets/images/ui-pressed.png";
            this.sceneEl.systems.material.loadTexture(r, {
                src: r
            }, e), this.sceneEl.systems.material.loadTexture(s, {
                src: s
            }, t)
        },
        closeAll: function() {
    ...
    AFRAME.registerSystem("painter", {
            ...
            document.addEventListener("stroke-started", function(e) {
                if (!s.startPainting) {
                    var t = document.getElementById("logo"),
                        i = t.getObject3D("mesh");
                    new AFRAME.TWEEN.Tween({
                        alpha: 1
                    }).to({
                        alpha: 0
                    }, 4e3).onComplete(function() {
                ...
                if (!e.shiftKey && !e.ctrlKey) {
                    ...
                    if (78 === e.keyCode) {
                        var i = document.querySelectorAll("[paint-controls]"),
        ...
        upload: function(e, t) {
            ...
            var i = this,
                r = "https://aframe.io/a-painter/?url=",
            ...
            if ("fileio" === a) {
                ...
                h.open("POST", "https://file.io"), h.onreadystatechange = function(s) {
                    if (4 === h.readyState) {
                        ...
                        n.success && (console.log("Uploaded link: ", r + n.link), i.sceneEl.emit("drawing-upload-completed", {
                            url: r + n.link
                        }), e && e())
                    } else i.sceneEl.emit("drawing-upload-error", {
                        errorInfo: null,
                        fileInfo: null
                    }), t && t()
                }, h.send(o)
                ...
                u.done(function(t) {
                    console.log("Uploaded link: ", r + t.cdnUrl), i.sceneEl.emit("drawing-upload-completed", {
                        url: r + t.cdnUrl
                    }), e && e()
                }).fail(function(e, r) {
                    i.sceneEl.emit("drawing-upload-error", {
                        errorInfo: e,
                        fileInfo: r
                    }), t && t(e)
                }).progress(function(e) {
                    i.sceneEl.emit("drawing-upload-progress", {
                        progress: e.progress
                    })
                })
            }
    ...
    AFRAME.registerComponent("orbit-controls", {
        ...
        init: function() {
            var e = this.el.sceneEl,
                t = this.setupControls.bind(this);
        ...
        setupControls: function() {
            var e = this.el.sceneEl.renderer,
                t = this.el.getObject3D("camera"),
                i = this.controls = new THREE.OrbitControls(t, e.domElement),
                r = this.el.getAttribute("position");
    ...
    AFRAME.registerSystem("paint-controls", {
        ...
        init: function() {
            ...
            var t = this.el,
                i = this,
                r = "assets/images/controller-pressed.png",
                s = null;
            this.controller = null, this.modelLoaded = !1, this.onModelLoaded = this.onModelLoaded.bind(this), t.addEventListener("model-loaded", this.onModelLoaded), t.addEventListener("changeBrushSizeAbs", function(e) {
                if ((0 !== e.detail.axis[0] || 0 !== e.detail.axis[1]) && i.previousAxis !== e.detail.axis[1]) {
                    var r = e.detail.axis[1] / 300,
                        s = t.components.brush.schema.size,
                ...
                if ((0 !== e.detail.axis[0] || 0 !== e.detail.axis[1]) && i.previousAxis !== e.detail.axis[1]) {
                    ...
                    var r = (e.detail.axis[1] + 1) / 2,
                        s = (i.startAxis - r) / 2;
                    i.startAxis = r;
                    var n = i.el.getAttribute("brush").size,
                        a = t.components.brush.schema.size,
                ...
                var i = e.detail.name;
                if (s = Utils.getTooltips(i), "windows-motion-controls" === i);
                else if ("oculus-touch-controls" === i) {
                    ...
                    t.setAttribute("json-model", {
                        src: "assets/models/controller_vive.json"
                    })
                }
            ...
            }), t.sceneEl.systems.material.loadTexture(r, {
                src: r
            }, e), this.startAxis = 0, this.numberStrokes = 0, document.addEventListener("stroke-started", function(e) {
                if (e.detail.entity.components["paint-controls"] === i && (i.numberStrokes++, i.system.numberStrokes++, 3 === i.system.numberStrokes)) {
                    var t = Array.prototype.slice.call(document.querySelectorAll("[tooltip]")),
                        r = {
                            opacity: 1
                        },
                        s = new AFRAME.TWEEN.Tween(r).to({
                            opacity: 0
        ...
        updateModel: function(e, t) {
            var i = "up" === t ? this.material : this.highLightMaterial,
                r = this.buttonMeshes,
                s = r && r[e];
    ...
    AFRAME.registerComponent("ui", {
        ...
        init: function() {
            ...
            e.addEventListener("controllerconnected", function(i) {
                ...
                }, "oculus-touch-controls" === s ? (r.uiEl.setAttribute("rotation", "45 0 0"), t.setAttribute("position", "0 0.13 -0.08"), r.rayAngle = 0, e.setAttribute("ui-raycaster", {
                    rotation: 0
                })) : "windows-motion-controls" === s && (r.rayAngle = 25, r.rayDistance = 1, e.setAttribute("ui-raycaster", {
                    rotation: -30,
                    far: r.rayDistance
        ...
        onHueDown: function(e) {
            var t, i = this.objects.hueWheel,
                r = this.colorWheelSize;
        ...
        hsv2rgb: function(e) {
            var t, i, r, s, n, a, o, h, u = THREE.Math.clamp(e.h, 0, 1),
        ...
        updateMaterials: function() {
            ...
            return function() {
                var t = this,
                    i = this.pressedObjects,
                    r = this.unpressedObjects,
                ...
                this.hoveredOffObjects.forEach(function(e) {
                    ...
                    var r = i[e],
                        s = t.highlightMaterials[r.name];
                    r.material = s.pressed || r.material
                }), Object.keys(r).forEach(function(e) {
                    var i = r[e],
                        s = t.highlightMaterials[i.name];
                    i.material = s.normal, delete r[e]
                }), Object.keys(s).forEach(function(e) {
                    var i = s[e],
                        r = t.highlightMaterials[i.name];
        ...
        onModelLoaded: function(e) {
            function t(e) {
                ...
                var t = {
                    ...
                    i = new AFRAME.TWEEN.Tween(t).to({
                        opacity: 1
                    }, 500).onUpdate(function() {
                        n.messagesMaterial.opacity = t.opacity
                    }).chain(new AFRAME.TWEEN.Tween(t).to({
                        opacity: 0
                    }, 500).delay(3e3).onComplete(function() {
                        e.visible = !1
                    }).onUpdate(function() {
                        n.messagesMaterial.opacity = t.opacity
                    }));
            ...
            if (r = e.detail.model, "obj" === e.detail.format && r.getObjectByName("brightnesscursor")) {
                ...
                this.el.sceneEl.systems.material.loadTexture(a, {
                    src: a
                }, function(e) {
        ...
        loadBrushes: function() {
            ...
            return function(t, i) {
                function r(t, i, r) {
                    ...
                    return r && !e[a] ? void l.el.sceneEl.systems.material.loadTexture(r, {
                        src: r
                    }, n) : void n()
                }

                function s(t, i) {
                    var r = l.brushButtonsMapping[i.name],
                        s = e[r] || new THREE.MeshBasicMaterial;
                ...
                var n, a, o, h, u = 0,
                    c = this.uiEl.getObject3D("mesh"),
                    d = Object.keys(AFRAME.BRUSHES),
                    l = this;
                if (!(t < 0 || t >= this.brushesPagesNum))
                    for (0 === t ? this.objects.previousPage.visible = !1 : this.objects.previousPage.visible = !0, t === this.brushesPagesNum - 1 ? this.objects.nextPage.visible = !1 : this.objects.nextPage.visible = !0, h = 0; h < i; h++) o = t * i + h, n = d[o], a = n && AFRAME.BRUSHES[n].prototype.options.thumbnail, r(n, u, a), u += 1
            }
        }(),
        nextPage: function() {
        ...
        initHighlightMaterial: function(e) {
            var t = e.name,
                i = this.brushRegexp.test(t),
                r = t.indexOf("history") !== -1,
                s = "hue" === t || "huecursor" === t,
                n = {
                    normal: e.material,
                    hover: e.material,
        ...
        updateSizeSlider: function(e) {
            var t = this.objects.sizeSlider,
                i = t.geometry.boundingBox,
                r = this.objects.sizeCursor,
                s = i.max.x - i.min.x,
                n = e / AFRAME.components.brush.schema.size.max,
                a = n * s;
        ...
        updateColorUI: function(e) {
            var t = new THREE.Color(e),
                i = this.hsv = this.rgb2hsv(t.r, t.g, t.b),
                r = 2 * i.h * Math.PI,
                s = i.s * this.colorWheelSize,
                n = s * Math.cos(r),
                a = s * Math.sin(r);
        ...
        updateBrushSelector: function(e) {
            var t = this,
                i = Object.keys(this.brushButtonsMapping),
                r = this.brushButtonsMapping;
        ...
        close: function() {
            ...
            this.closed || (e = new AFRAME.TWEEN.Tween(i).to({
                x: 0,
                y: 0,
                z: 0
            }, 100).onUpdate(function() {
    ...
    AFRAME.registerComponent("ui-raycaster", {
        ...
        refreshObjects: function() {
            var e, t, i = this.data;
            if (i.objects)
                for (t = this.el.sceneEl.querySelectorAll(i.objects), this.objects = [], e = 0; e < t.length; e++) this.objects.push(t[e].object3D);
            else this.objects = this.el.sceneEl.object3D.children
        },
        tick: function(e) {
            var t, i, r, s = this.el,
                n = this.data,
                a = this.prevCheckTime;
            a && e - a < n.interval || (r = this.intersectedEls.slice(), this.updateOriginDirection(), i = this.raycaster.intersectObjects(this.objects, n.recursive), i = i.filter(function(e) {
                ...
                var t = e.object.el;
                t.emit("raycaster-intersected", {
                    el: s,
                    intersection: e
                })
            }), i.length && s.emit("raycaster-intersection", {
                els: t,
                intersections: i
            }), r.forEach(function(e) {
                t.indexOf(e) === -1 && (s.emit("raycaster-intersection-cleared", {
                    el: e
    ...
    ! function() {
        ...
        for (var e = {
            ...
            var n = t[i];
            n.materialOptions.textureSrc ? n.materialOptions.converter = window.atlas.getUVConverters(n.materialOptions.textureSrc) : n.materialOptions.converter = window.atlas.getUVConverters(null), AFRAME.registerBrush(n.name, Object.assign({}, e, {
                materialOptions: n.materialOptions
            }), {
        ...
        for (var e = {
                ...
                addPoint: function() {
                    ...
                    return function(h, u, c, d, l) {
                        ...
                        var b = (6 * this.data.numPoints * 2, 0),
                            g = 1;
            ...
            var n = t[i];
            n.materialOptions.textureSrc && (n.materialOptions.map = window.atlas.map, n.materialOptions.converter = window.atlas.getUVConverters(n.materialOptions.textureSrc), delete n.materialOptions.textureSrc), AFRAME.registerBrush(n.name, Object.assign({}, e, {
                materialOptions: n.materialOptions
            }), {
                thumbnail: n.thumbnail,
                spacing: n.spacing,
    ...
    AFRAME.registerBrush("spheres", {
        ...
        addPoint: function(e, t, i, r, s) {
            var n = new THREE.Mesh(this.geometry, this.material),
                a = this.data.size / 2 * r;
        ...
        tick: function(e, t) {
            for (var i = 0; i < this.object3D.children.length; i++) {
                var r = this.object3D.children[i],
                    s = (Math.sin(r.phase + e / 500) + 1) / 2 + .1;
    ...
    AFRAME.registerBrush("cubes", {
        ...
        addPoint: function(e, t, i, r, s) {
            var n = new THREE.Mesh(this.geometry, this.material),
                a = r * this.data.size * Math.random();
